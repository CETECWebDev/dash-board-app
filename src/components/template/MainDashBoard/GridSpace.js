...
export default function GridSpace() {
    return (
        <div className='grid grid-cols-1 lg:[grid-template-columns:1fr_1fr_auto] px-5 mt-3 gridSpace place-content-center gap-y-3 lg:gap-3 w-full mb-5'>
            ...
            <div className='col-span-2 w-full h-[500px] lg:h-auto flex lg:flex-row flex-col gap-3  items-center'>
                <div className='lg:w-[70%] w-full h-full'>
                    < AreaChart />
                </div>
                <div className='lg:w-[30%] w-full h-full bg-[var(--colCard)] rounded-xl py-3' >
                    < BarChart />
                </div>
            </div>
