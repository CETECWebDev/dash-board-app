...
export default function Employees({ employees }) {
  ...
  return (
    <div className="min-h-screen p-5 text-[var(--colTextA)] space-y-4">
      ...
      <button href={'/add-user'} className='  border-2 rounded-full py-2 px-4 border-[var(--colTextA)] hover:text-[var(--textHover)] hover:border-[var(--textHover)]'>+ Add user</button>
