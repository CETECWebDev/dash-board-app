...
export default function Roads() {
  ...
  return (
    <div className="p-5">
      ...
      <Link href={'/add-road'} className='border-2 rounded-full py-2 px-4 border-[var(--colTextA)] hover:text-[var(--textHover)] hover:border-[var(--textHover)]'> {translate(dir,"addRoad.title")} </Link>
      </div>
      {/* Cards */}
